...
# 1111 produces 4 because each digit (all 1) matches the next. 1234 produces 
# 0 because no digit matches the next. 

# 91212129 produces 9 because the only digit that matches the next one is the 
# last digit, 9. What is the solution to your captcha?
...
def main( argv ):
	...
	print( "Part 1 total:  " + str( p1 ) )
	print( "Part 2 total:  " + str( p2 ) )
