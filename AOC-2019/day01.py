...
def main( argv ):
    ...
    for value in data:  # Integer division rounds down
        part1Fuel += ((int( value.strip() ) / 3) - 2)
        part2Fuel += calcFuel( int( value.strip() ) )

    print( "Required fuel for part 1: %s" % part1Fuel )
    print( "Required fuel for part 2: %s" % part2Fuel )
