...
def main( argv ):
    ...
    for line in part2Data:
        ...
        # At this point what ever is left in the stack needs closure
        # Pop each one off and score it's close symbol
        while not stack.empty():
            score = ( (score * 5) + points[ stack.get() ] )

        finalScore.append( score )

    print( "Part 2 answer: %s" % statistics.median( finalScore ) )
