...
# of detecting all beacons in a large cube centered on the scanner; beacons that
# are at most 1000 units away from the scanner in each of the three axes (x, y,
...
# different orientations: facing positive or negative x, y, or z, and
...
def main( argv ):
    ...
    for i in range( 4 ):
        print( np.rot90( data, i, axes=(0,1) ) )
        #print( data )
        print( '\n' )
